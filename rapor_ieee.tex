...
Gradient Boosting FP=18 ile ikinci, Logistic Regression ise FP=19
...
\begin{figure}[H]
  ...
  \caption{Final ROC eğrileri: LR (AUC=0.708), RF (AUC=0.782), GB (AUC=0.7936).}
  \label{fig:roc}
\end{figure}
...
\subsection{Model Seçimi: F1 ve AUC Açısından}
